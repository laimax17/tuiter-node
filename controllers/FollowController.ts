 ...
 */
  ...
  *     </li>
  *     <li>DELETE /api/users/:uid/unfollowsAll to unfollows all the users they are following
  *     </li> 
  *     <li>DELETE /api/users/:uid/removefollowers/all to deletes all the followers
  *     </li>
  * </ul>
